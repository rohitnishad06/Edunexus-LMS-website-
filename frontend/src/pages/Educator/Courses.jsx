    ...
    <div className="flex min-h-screen bg-gray-100">
      <div className="w-[100%] min-h-screen p-4 sm:p-6 bg-gray-100">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
          ...
          <div>
            <button
              className="bg-[#020e26] text-white px-4 py-2 rounded hover:bg-gray-500"
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              {creatorCourseData?.map((course, index) => (
                ...
                >
                  <td className="py-3 px-4 flex item-centre gap-4">
                  ...
                  <td className="px-4 py-3">
                    <FaEdit className="text-gray-800 hover:text-blue-600 cursor-pointer" onClick={() => navigate(`/editcourse/${course?._id}`)} />
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="md:hidden space-y-4">
          ...
          {/* Add small screen table content here */}
        </div>
      </div>
    </div>
  );
